...
//   const micClass = `
//     w-32 h-32 rounded-full flex items-center justify-center z-20 shadow-xl
//     transition-all duration-300
//     ${isDisabled ? 'bg-gray-300 text-gray-400 cursor-not-allowed' : ''}
//     ${isListening ? 'bg-gradient-to-br from-blue-600 to-blue-400 text-white animate-pulse' : 'bg-gradient-to-br from-blue-500 to-blue-600 text-white hover:scale-105'}
//   `;

//   return (
//     <button onClick={onClick} disabled={isDisabled} className={micClass}>
//       <svg
