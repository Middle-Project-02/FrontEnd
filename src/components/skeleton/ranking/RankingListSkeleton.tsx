    ...
    <div className="flex flex-col pt-44 px-30 gap-12">
      ...
      <div className="flex flex-col gap-28">
        <div className="flex flex-col gap-8">
          <Skeleton className="h-[30px] w-4/6 bg-gray-300" />
        ...
        <div className="first flex gap-20">
          ...
          <div className="flex-[3] flex flex-col gap-12 justify-center">
            <Skeleton className="h-[20px] w-2/5 bg-gray-300" />
            <Skeleton className="h-[20px] w-4/5 bg-gray-200" />
            <Skeleton className="h-[40px] w-full bg-blue-400" />
          </div>
        </div>
        <div className="flex flex-col gap-12">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="reguler flex gap-20 mt-16">
              ...
              <div className="flex-[3] flex flex-col gap-12 justify-center">
                <Skeleton className="h-[20px] w-2/5 bg-gray-300" />
                <Skeleton className="h-[20px] w-3/5 bg-gray-200" />
              </div>
            </div>
          ))}
        </div>
